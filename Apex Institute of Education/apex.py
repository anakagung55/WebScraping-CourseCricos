...
# === SCRAPER PER URL ===
async def scrape_apex(url, browser):
    data = {
        "url": url,
        "course_description": "",
...
# === MAIN FUNCTION UNTUK LOOP EXCEL ===
async def main():
    df = pd.read_excel("Apex Institute of Education/apex.xlsx")  # file harus punya kolom 'url'
